...
export class ProduitService {
  ...
  produits : any[] = [
    ...
    {name:'Viande de Chèvre Braisée', prix: 120, photo:'../../assets/img/croupions-de-dindes.jpeg', description:'Chèvre braisé sur feu doux à la sauce de persil et mouscade.', categorie:'Plat principal'},
    {name:'Porc Braisé', prix: 120, photo:'../../assets/img/mouton-braisé.jpg', description:'Porc braisé sur feu doux à la sauce de persil et mouscade. Excellent plat pour plusieurs.', categorie:'Plat principal'},
    {name:'Brochette Boeuf', prix: 110, photo:'../../assets/img/brochettes-de-boeuf-recette.jpeg', description:'Brochettes de boeuf braisé sur feu doux à la sauce de persil et mouscade.', categorie:'Accompagnement'},
    {name:'Frites', prix: 20, photo:'../../assets/img/frites.jpeg', description:'Frites croustillantes, dorées à feu doux. Excellent accompagnement pour vos plats.', categorie:'Accompagnement'},
    {name:'Manioc', prix: 20, photo:'../../assets/img/kwanga.jpg', description:'Manioc, chikwangue ou kwangua. Accompagnement de luxe pour vos plats.', categorie:'Accompagnement'},
