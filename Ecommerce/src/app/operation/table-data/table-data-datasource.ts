...
export class TableDataDataSource extends DataSource<Produits> {
  data: Produits[] = [];
   ...
   */
  private getPagedData(data: Produits[]): Produits[] {
    if (this.paginator) {
   ...
   * this would be replaced by requesting the appropriate data from the server.
   */
  private getSortedData(data: Produits[]): Produits[] {
    ...
    return data.sort((a, b) => {
      ...
      switch (this.sort?.active) {
        ...
        case 'prix': return compare(+a.prix, +b.prix, isAsc);
